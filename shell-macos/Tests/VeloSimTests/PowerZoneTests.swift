...
final class PowerZoneTests: XCTestCase {
    ...
    func testZoneBoundariesAt200Ftp() {
        ...
        XCTAssertEqual(PowerZone.of(watts: 111, ftp: 200), .z1)
        XCTAssertEqual(PowerZone.of(watts: 112, ftp: 200), .z2)
        XCTAssertEqual(PowerZone.of(watts: 150, ftp: 200), .z2)
        XCTAssertEqual(PowerZone.of(watts: 152, ftp: 200), .z3)
        XCTAssertEqual(PowerZone.of(watts: 180, ftp: 200), .z3)
        XCTAssertEqual(PowerZone.of(watts: 182, ftp: 200), .z4)
        XCTAssertEqual(PowerZone.of(watts: 210, ftp: 200), .z4)
        XCTAssertEqual(PowerZone.of(watts: 212, ftp: 200), .z5)
