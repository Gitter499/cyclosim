...
let supportExclude = [
    ...
    "UI/HUD/RideControls.swift",
    "UI/Screens/MetalRideView.swift",
    "UI/Settings/SettingsView.swift",
    "UI/Settings/SettingsChrome.swift",
    ...
    "UI/Screens/QuickStartRow.swift",
    "UI/Screens/PairingView.swift",
    "UI/Screens/RouteSelectView.swift",
    "UI/Screens/WorkoutLibraryView.swift",
    "UI/Screens/FTPTestViews.swift",
