...
let supportExclude = [
    ...
    "UI/Shell/AppShellView.swift",
    "UI/Shell/HomeDashboardView.swift",
    "UI/Shell/ActivitiesCatalogView.swift",
    "UI/Shell/RideHistoryView.swift",
    "UI/Shell/RideModeView.swift",
    "UI/Shell/PreRidePanel.swift",
    "BLE",
    ...
    targets: [
        ...
        .executableTarget(
            ...
            exclude: [
                ...
                "UI/Shell/ShellDestination.swift",
            ],
            swiftSettings: liquidGlassSwiftSettings,
            linkerSettings: [
